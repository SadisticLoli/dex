...
iconData = {
	Configuration = {index = 58,colour = "grey"},
	UniversalConstraint = {index = 123,colour = "green"},
	MeshPart = {index = 73,colour = "purple"},
	MaterialVariant = {index = 130,colour = "yellow"},
	ShirtGraphic = {index = 40,colour = "purple"},
	DialogChoice = {index = 63,colour = "blue"},
	PlaneConstraint = {index = 134,colour = "green"},
	RopeConstraint = {index = 89,colour = "green"},
	Hat = {index = 45,colour = "purple"},
	ImageHandleAdornment = {index = 108,colour = "purple"},
	ImageButton = {index = 52,colour = "green"},
	Humanoid = {index = 9,colour = "yellow"},
	PrismaticConstraint = {index = 88,colour = "green"},
	ForceField = {index = 37,colour = "green"},
	Motor6D = {index = 106,colour = "purple"},
	MaterialsService = {index = 131,colour = "blue"},
	SoundService = {index = 31,colour = "grey"},
	ValueBase = {index = 4,colour = "grey"},
	Highlight = {index = 133,colour = "yellow"},
	StarterGui = {index = 46,colour = "blue"},
	Folder = {index = 77,colour = "yellow"},
	CylinderHandleAdornment = {index = 109,colour = "purple"},
	ClickDetector = {index = 41,colour = "blue"},
	RodConstraint = {index = 90,colour = "green"},
	SpecialMesh = {index = 8,colour = "purple"},
	SoundGroup = {index = 85,colour = "yellow"},
	Tool = {index = 17,colour = "yellow"},
	Shirt = {index = 43,colour = "purple"},
	Pants = {index = 44,colour = "purple"},
	FlagStand = {index = 39,colour = "blue"},
	Attachment = {index = 81,colour = "blue"},
	Seat = {index = 35,colour = "red"},
	ServerScriptService = {index = 71,colour = "green"},
	WrapTarget = {index = 122,colour = "purple"},
	Trail = {index = 93,colour = "yellow"},
	TorsionSpingConstraint = {index = 125,colour = "green"},
	Torque = {index = 103,colour = "blue"},
	PlayerScripts = {index = 78,colour = "blue"},
	SphereHandleAdornment = {index = 112,colour = "purple"},
	ProximityPrompt = {index = 124,colour = "blue"},
	BodyMover = {index = 14,colour = "blue"},
	Smoke = {index = 59,colour = "grey"},
	["WrapTarget (alt)"] = {index = 127,colour = "purple"},
	["WrapLayer (alt)"] = {index = 126,colour = "blue"},
	Handles = {index = 53,colour = "blue"},
	AlignOrientation = {index = 100,colour = "red"},
	ImageLabel = {index = 49,colour = "green"},
	Explosion = {index = 36,colour = "yellow"},
	Lighting = {index = 13,colour = "yellow"},
	SelectionLasso = {index = 57,colour = "red"},
	TextLabel = {index = 50,colour = "blue"},
	PathfindingModifier = {index = 128,colour = "green"},
	WrapLayer = {index = 121,colour = "blue"},
	Sparkles = {index = 42,colour = "purple"},
	ChatService = {index = 33,colour = "blue"},
	Decal = {index = 7,colour = "green"},
	ReplicatedStorage = {index = 70,colour = "red"},
	RemoteEvent = {index = 75,colour = "yellow"},
	Instance = {index = 0,colour = "blue"},
	LineForce = {index = 101,colour = "blue"},
	ConeHandleAdornment = {index = 110,colour = "purple"},
	NetworkServer = {index = 15,colour = "green"},
	ModuleScript = {index = 76,colour = "red"},
	VideoFrame = {index = 120,colour = "blue"},
	VectorForce = {index = 102,colour = "blue"},
	StarterPlayer = {index = 79,colour = "blue"},
	NoCollisionConstraint = {index = 105,colour = "red"},
	Accessory = {index = 32,colour = "purple"},
	Actor = {index = 113,colour = "blue"},
	Backpack = {index = 20,colour = "yellow"},
	LocalScript = {index = 18,colour = "blue"},
	HopperBin = {index = 22,colour = "blue"},
	['(unused)'] = {index = 119,colour = "purple"},
	Sky = {index = 28,colour = "blue"},
	Model = {index = 2,colour = "red"},
	LocalizationService = {index = 92,colour = "green"},
	SurfaceSelection = {index = 55,colour = "yellow"},
	HumanoidDescription = {index = 104,colour = "yellow"},
	SelectionBox = {index = 54,colour = "blue"},
	FaceControls = {index = 129,colour = "blue"},
	NetworkReplicator = {index = 29,colour = "blue"},
	ServerStorage = {index = 69,colour = "green"},
	NegateOperation = {index = 72,colour = "red"},
	Workspace = {index = 19,colour = "green"},
	Bone = {index = 114,colour = "purple"},
	Debris = {index = 30,colour = "purple"},
	PackageLink = {index = 98,colour = "yellow"},
	ArcHandles = {index = 56,colour = "blue"},
	Texture = {index = 10,colour = "yellow"},
	Players = {index = 21,colour = "blue"},
	LocalizationTable = {index = 97,colour = "green"},
	Script = {index = 6,colour = "green"},
	BoxHandleAdornment = {index = 111,colour = "purple"},
	Beam = {index = 96,colour = "yellow"},
	Terrain = {index = 65,colour = "green"},
	CylindricalConstraint = {index = 95,colour = "green"},
	WeldConstraint = {index = 94,colour = "blue"},
	LineHandleAdornment = {index = 107,colour = "purple"},
	Camera = {index = 5,colour = "grey"},
	TextButton = {index = 51,colour = "blue"},
	SpringConstraint = {index = 91,colour = "green"},
	Fire = {index = 61,colour = "red"},
	BallSocketConstraint = {index = 86,colour = "green"},
	SoundEffect = {index = 84,colour = "purple"},
	UIComponent = {index = 26,colour = "grey"},
	PostEffect = {index = 83,colour = "grey"},
	ParticleEmitter = {index = 80,colour = "blue"},
	TestService = {index = 68,colour = "green"},
	BillboardGui = {index = 64,colour = "red"},
	BindableEvent = {index = 67,colour = "yellow"},
	BindableFunction = {index = 66,colour = "purple"},
	Part = {index = 1,colour = "grey"},
	RemoteFunction = {index = 74,colour = "purple"},
	Team = {index = 24,colour = "red"},
	Animation = {index = 60,colour = "grey"},
	Sound = {index = 11,colour = "red"},
	Joint = {index = 34,colour = "blue"},
	ScreenGui = {index = 47,colour = "blue"},
	LinearVelocity = {index = 132,colour = "blue"},
	AlignPosition = {index = 99,colour = "red"},
	SpawnLocation = {index = 25,colour = "blue"},
	HingeConstraint = {index = 87,colour = "green"},
	Player = {index = 12,colour = "blue"},
	Teams = {index = 23,colour = "red"},
	NetworkClient = {index = 16,colour = "blue"},
	Frame = {index = 48,colour = "yellow"},
	Flag = {index = 38,colour = "blue"},
	Dialog = {index = 62,colour = "blue"},
	
	byIndex = {}
};

for i, v in next, iconData do
    iconData.byIndex[v.index or 0] = v
end

for i, theme in pairs(colorPalettes) do
    for i, hex in pairs(theme) do
	    hex = hex:gsub("#","")
	    local r = tonumber("0x"..hex:sub(1,2))
	    local g = tonumber("0x"..hex:sub(3,4))
	    local b = tonumber("0x"..hex:sub(5,6))
	    theme[i] = Color3.fromRGB(r,g,b)
    end
end
...
return search]==]
	...
	Explorer.Init = function()
		Explorer.ClassIcons = Lib.IconMap.newLinear("rbxassetid://8180090910",64,64)
...
local function main()
	...
	Lib.IconMap = (function()
		...
		funcs.Display = function(self,obj,index)
			...
			if self.MapId == "rbxassetid://8180090910" then
			    obj.ImageColor3 = colorPalettes[currentTheme][(iconData.byIndex[tonumber(index) or 0] or {}).colour or "grey"]
			    if iconData[obj.ClassName] then
			        obj.ImageRectOffset = Vector2.new(math.floor(index%12)*64, math.floor(index/12)*64)
			    else
			        obj.ImageRectOffset = Vector2.new(0, 0)
			    end
			    
			    obj.ImageRectSize = Vector2.new(64, 64)
			else
